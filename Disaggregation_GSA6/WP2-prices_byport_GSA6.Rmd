...
wd = "C:/Users/alice/OneDrive - CNR/Documenti - SURIMI-Internal-grp/General/Deliverable 2.1/Disaggregation_GSA6/Data Input/" 
...
nvessel_port = read.csv(paste0(wd,"num_vessels_per_year_port_gear_length.csv")) %>% 
...
port_coord = read.csv(paste0(wd,"ports.csv")) %>% 
...
port_coord %>% 
 ggplot() +
  ...
  geom_label_repel(
      ...
      aes(x = lon, y = lat, label = port_code),
      size = 3,
